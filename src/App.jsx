            ...
            <div className="bg-white rounded-[24px] md:rounded-[32px] shadow-sm overflow-hidden border border-gray-50 flex flex-col">
              ...
              <div className="p-5 md:p-6 flex flex-col bg-white">
                ...
                <div className="relative group select-none">
                  ...
                  <div ref={progressBarRef} onClick={handleBarClick} className="w-full h-1.5 md:h-2 bg-[#F3F5FA] rounded-full overflow-hidden cursor-pointer relative">
                    <div className="h-full bg-[#3E3B53] transition-all duration-200 ease-linear rounded-full relative" style={{ width: `${progress}%` }}>
                      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-3 h-3 bg-[#3E3B53] border-2 border-white rounded-full shadow-md opacity-0 md:group-hover:opacity-100 transition-opacity" />
                    </div>
                  </div>
                </div>
              </div>

              <div className="p-4 md:p-5 flex items-start space-x-4 cursor-pointer hover:bg-gray-50 transition-all border-t border-gray-50">
